...
public class AnimalDatabase {
    ...
    public void createAnimal(String name, int age, String specie){
        String sql = "INSERT INTO animallist (name, age, specie) VALUES (?, ?, ?)";
    ...
    public List<Animal> getAll(){
        ...
        String sql = "SELECT id, name, age, specie FROM animalList";
